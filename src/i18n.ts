...
// Try to import external translation files
import enFromFile from './locales/en.json';
import frFromFile from './locales/fr.json';

// Inline fallback English translations - guaranteed to work even if imports fail
const fallbackEnglishMessages = {
  "welcome": "Welcome!",
  "app": {
    "logo": "Marathoons",
    "nav": {
...
// Use imported translations if available, otherwise use inline fallback
const enMessages = enFromFile || fallbackEnglishMessages;
const frMessages = frFromFile || fallbackEnglishMessages;
...
// Dynamic locale detection was causing 'fr' to be minified to 'Vf' in production
const FIXED_LOCALE = 'en';

// Create i18n instance with hardcoded English locale
